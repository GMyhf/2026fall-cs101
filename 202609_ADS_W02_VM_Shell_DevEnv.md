...
![登录 xLab](courseware/assets/w02/xlab-login.png)
![添加公钥](courseware/assets/w02/xlab-pubkey.png)
![新建节点](courseware/assets/w02/xlab-new-node.png)

节点卡片是本地连接的入口：复制卡片上的 SSH 命令粘贴到本机终端；装好 Remote-SSH 后可以点「打开 VS Code」。

![节点卡片](courseware/assets/w02/xlab-node-card.png)
