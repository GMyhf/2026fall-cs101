...
// overview table
{
  ...
  const rows = [
    ["T1", "成绩单核对", "字典计数、多关键字排序、格式化输出（W2、W4）", "★☆☆☆☆", "15"],
    ["T2", "括号嵌套深度", "栈、边界判断（W7）", "★★☆☆☆", "15"],
    ["T3", "会议室数量", "区间分组、差分 / 排序（W10）", "★★★☆☆", "15"],
    ["T4", "穿墙迷宫", "带状态的 BFS（W12）", "★★★☆☆", "15"],
    ["T5", "作业时间分配", "0-1 背包 + 次要目标（W11）", "★★★★☆", "20"],
    ["T6", "电网巡检", "最小瓶颈路 = 排序 + 并查集（W6、W9）", "★★★★★", "20"],
  ];
