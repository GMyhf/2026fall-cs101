...
**12559: 最大最小整数 v0.3**，<http://cs101.openjudge.cn/practice/12559/>
...
| 5 | 装箱问题 | 01017 | 贪心 + 打表 |
| 6 | 最大最小整数 v0.3 | 12559 | 自定义比较、交换论证 |
| 7 | 因材施教 | 19948 | 排序型贪心 |
| 8 | 军备竞赛 | 18211 | 双指针贪心 |
...
1. 证明：按 `a+b > b+a` 排序得到的拼接结果是最大的。（提示：交换论证 + 传递性）
...
4. 贪心 = **排序 + 一遍扫**，难在选排序键；不会证明就**构造反例**。
   找零 `[1,3,4]` 凑 6 是标准反例。
5. **看到 n 的范围就知道该写哪个复杂度的版本**——这是本周最该带走的习惯。
