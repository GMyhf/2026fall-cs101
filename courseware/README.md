...
| 5 | `202609_ADS_W05_October_Exam_Review` | 31 | 14:27（旧 28 页版，待重合成） | 10 月月考样卷（6 题 / 112 分钟）、订正方法、考场策略 |
...
| 14 | `202612_ADS_W14_AI_Literacy_Exam_Recap` | 40 | 15:19（旧 33 页版，待重合成） | LLM 原理、幻觉、提示词、12 月月考讲评（6 题） |
| 15 | `202612_ADS_W15_Knowledge_Graph_Neural_Network` | 30 | 11:44（旧 24 页版，待重合成） | 知识图谱、RAG、神经网络、反向传播、CNN |
| 16 | `202612_ADS_W16_Review_Final_Machine_Exam` | 39 | 20:09（旧 40 页版，待重合成） | 知识体系总结、期末上机考试命题方案与样卷 |

课件合计 **593 页**，版面 16:9，中文字体 **微软雅黑**，代码字体 **Consolas**。
